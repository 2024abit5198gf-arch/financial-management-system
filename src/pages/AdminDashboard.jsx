    ...
    <section className="space-y-8">
      <div className="rounded-3xl border border-slate-800 bg-slate-900/95 p-8 shadow-2xl shadow-slate-950/35">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-semibold text-white">System overview</h1>
        ...
        {isLoading ? (
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-3xl bg-slate-950 p-6 text-slate-100 shadow-xl shadow-slate-950/20">
              ...
              <p className="mt-3 text-slate-400">Registered learners at Kigaragara.</p>
            </div>
            <div className="rounded-3xl bg-slate-950 p-6 text-slate-100 shadow-xl shadow-slate-950/20">
              ...
              <p className="mt-3 text-slate-400">Unpaid tuition and fees.</p>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-900/95 p-8 shadow-2xl shadow-slate-950/35">
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-4">
          <button className="btn-primary rounded-3xl px-4 py-3 text-sm">Manage users</button>
